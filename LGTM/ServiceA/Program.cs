...
// Service Identity
const string serviceName = "Lgtm.ServiceA";
...
builder.Services.AddOpenTelemetry()
    .ConfigureResource(r => r.AddService("Lgtm.ServiceA"))
    .WithTracing(t => t
...
app.MapGet("serviceA/data", (ILogger<Program> logger) => {
    logger.LogInformation("Service A processing request");
